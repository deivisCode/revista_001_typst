...
preferida. Por exemplo, na súa obra _A República_, Platón compara o
...
#figure(
    ...
    caption: [Á dereita, modelo da ecuante de Ptolomeo. Imaxes de Wikipedia]
)
...
publicación do _De revolutionibus orbium coelestium_ de Copérnico.
